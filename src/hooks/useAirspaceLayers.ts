...
const useAirspaceLayers = (
  ...
  useEffect(() => {
    ...
    // Waypoints (when no procedure is active) - Navigraph Charts 스타일 적용
  ...
  }, [map, data, mapLoaded, showWaypoints, showObstacles, showAirspace, show3DAltitude, is3DView, hasActiveProcedure, isDayMode]);
};
