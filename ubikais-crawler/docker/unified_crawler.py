...
class Config:
    ...
    ubikais_username: str = os.environ.get("UBIKAIS_USERNAME", "").strip()
    ubikais_password: str = os.environ.get("UBIKAIS_PASSWORD", "").strip()
    ...
    def __post_init__(self):
        ...
        if not self.ubikais_username or not self.ubikais_password:
            raise ValueError("UBIKAIS_USERNAME and UBIKAIS_PASSWORD are required")
