...
def main():
    ...
    # 환경 변수에서 인증 정보 읽기
    username = os.environ.get("UBIKAIS_USERNAME", "").strip()
    password = os.environ.get("UBIKAIS_PASSWORD", "").strip()
    if not username or not password:
        raise RuntimeError("UBIKAIS_USERNAME and UBIKAIS_PASSWORD must be set")
